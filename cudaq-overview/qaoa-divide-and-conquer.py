...
def subgraph_solution(G, key, vertex_limit, subgraph_limit, layer_count, global_graph,seed ):
    ...
    """  
    results ={}
    seed = 123 # Edit this seed for new initial parameters among other seed-dependent elements
...
num_qubits = 9 # max number of qubits allowed in a quantum circuit
layer_count =2 # Layer count for the QAOA max cut # Edit this line to change the layer_count
results = {}
...
if rank!=0:
    ...
    print('The divide and conquer max cut coloring is',  G_colors_with_maxcut) 
